...
<template>
	<div id="Menu" class="fixed z-50 bottom-0 h-full w-full bg-white px-3">
		...
		<div class="flex items-center justify-between pt-5">
			<ul class="w-full">
				...
				<li @click="goTo('cart')"
					...
					<div class="flex items-center justify-center bg-[#ff4646] h-[35px] min-w-[35px] text-lg text-whiterounded-full">
				...
				<li v-else @click="signIn()"
					...
					<div class=" flex items-center text-[20px] font-semibold">
						...
						<p class="pl-4">Sign in / Register</p>
					</div>
				</li>
			</ul>
		</div>
